...
export async function createBranchAction(name: string, description?: string) {
  ...
  try {
    ...
    await supabase.from("categories").insert([
      { user_id: user.id, branch_id: branchId, name: "Alimentacao", color: "#ef4444", icon: "Utensils" },
      { user_id: user.id, branch_id: branchId, name: "Transporte", color: "#3b82f6", icon: "Car" },
      { user_id: user.id, branch_id: branchId, name: "Moradia", color: "#8b5cf6", icon: "Home" },
      { user_id: user.id, branch_id: branchId, name: "Lazer", color: "#ec4899", icon: "Gamepad2" },
      { user_id: user.id, branch_id: branchId, name: "Saude", color: "#10b981", icon: "Heart" },
      { user_id: user.id, branch_id: branchId, name: "Educacao", color: "#f59e0b", icon: "GraduationCap" },
      { user_id: user.id, branch_id: branchId, name: "Assinaturas", color: "#6366f1", icon: "ShoppingCart" },
      { user_id: user.id, branch_id: branchId, name: "Outros", color: "#6b7280", icon: "DollarSign" },
    ] as any);
