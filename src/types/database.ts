...
// Custom types for better developer experience
export type BranchWithMembers = Database["public"]["Tables"]["branches"]["Row"] & {
  branch_members: Array<
    Database["public"]["Tables"]["branch_members"]["Row"] & {
